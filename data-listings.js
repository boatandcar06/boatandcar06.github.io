...
const LISTINGS = [
  {
    ...
    couleur: "Gris Highland",
    puissance: "100 ch",
    description: "Clio V en excellent état, entretien complet chez Renault, parfaite première voiture ou citadine du quotidien.",
    points_forts: ["Faible consommation", "Carnet d'entretien à jour", "Contrôle technique OK", "Garantie 12 mois"],
    featured: true,
    status: "disponible"
  },
  {
    ...
    points_forts: ["Faible kilométrage", "4x2", "Garantie 12 mois", "Révisé"],
    featured: true,
    status: "disponible"
  },
  {
    ...
    points_forts: ["Boîte automatique", "Faible kilométrage", "Garantie 12 mois"],
    featured: false,
    status: "disponible"
  },
  {
    ...
    points_forts: ["Carnet constructeur", "Contrôle technique OK", "Garantie 12 mois"],
    featured: true,
    status: "disponible"
  },
  {
    ...
    points_forts: ["Faible consommation", "Carnet à jour", "Utilisation pro unique"],
    featured: true,
    status: "disponible"
  },
  {
    ...
    points_forts: ["Fiabilité reconnue", "Carnet à jour", "Contrôle technique OK"],
    featured: false,
    status: "disponible"
  },
  {
    ...
    points_forts: ["Faible kilométrage", "Sous garantie", "Polyvalent"],
    featured: false,
    status: "disponible"
  },
  {
    ...
    points_forts: ["Entretien à jour", "Compatible permis A2", "Faible consommation"],
    featured: true,
    status: "disponible"
  },
  {
    ...
    points_forts: ["Compatible A2", "Faible kilométrage", "Entretien Honda"],
    featured: false,
    status: "disponible"
  },
  {
    ...
    points_forts: ["Peu d'heures moteur", "Idéal débutant", "Entretien à jour"],
    featured: true,
    status: "disponible"
  },
  {
    ...
    points_forts: ["Léger et maniable", "Peu d'heures", "Remorque disponible"],
    featured: false,
    status: "disponible"
  }
];
